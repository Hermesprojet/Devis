...
test('une ligne de bordereau est ajoutée à un projet', async ({ page }) => {
  ...
  // Trois chiffres, toujours : `Date.now() % 1000` rend parfois « 5 », le
  // poste devient « 9.5 », et `getByText('9.5')` matche alors AUSSI l'option
  // d'un prix unitaire à 9,50. Vu en échec, une fois sur mille environ.
  ...
  // Une CELLULE, exactement : `getByText` cherche une sous-chaîne n'importe
  // où dans la page, y compris dans une liste déroulante de prix.
